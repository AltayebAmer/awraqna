...
(function (root, factory) {
  ...
  function draw(type, mm, head, rtl) {
    /* 273mm هو ارتفاع مساحة الطباعة كاملاً. يُطرح منه:
       ~24mm للترويسة إن طُلبت، و~9mm لسطر النسبة أسفل كل ورقة.
       إغفال سطر النسبة دفع الورقة إلى صفحة ثانية — حدث فعلاً وقُيس. */
    var H = (head ? 249 : 273) - 9;
    var top = 0;
    var g = [], x, y;
